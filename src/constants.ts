...
// Network commitment level for transaction confirmation
// "confirmed" = 1 block confirmation
// "finalized" = 32 block confirmations (~21 seconds)
// "processed" = 0 block confirmations (instant)
